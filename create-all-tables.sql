...
-- CreateEnum
CREATE TYPE "TeamMemberRole" AS ENUM ('leader', 'member', 'observer');
...
-- CreateEnum
CREATE TYPE "InspectionStatus" AS ENUM ('scheduled', 'in_progress', 'completed', 'approved', 'rejected', 'archived');

-- CreateEnum
CREATE TYPE "FacadeSideType" AS ENUM ('front', 'back', 'left', 'right', 'internal');
...
CREATE TABLE "anchor_points" (
    ...
    "archived_by_id" TEXT,
    "floor_plan_id" TEXT,
    "photo_upload_pending" BOOLEAN NOT NULL DEFAULT false,
    ...
    "inspection_interval" INTEGER DEFAULT 180,
...
CREATE TABLE "anchor_tests" (
    ...
    "equipment_calibration" TIMESTAMP(3),
...
CREATE TABLE "facade_inspections" (
    ...
    CONSTRAINT "facade_inspections_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "facade_sides" (
    "id" TEXT NOT NULL,
    ...
    "available_floors" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "available_divisions" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "order" INTEGER NOT NULL DEFAULT 0,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "facade_sides_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "pathology_markers" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "pathology_markers_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "inspection_reports" (
    "id" TEXT NOT NULL,
    "facade_inspection_id" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX "facade_inspections_project_id_idx" ON "facade_inspections"("project_id");

-- CreateIndex
CREATE INDEX "facade_inspections_status_idx" ON "facade_inspections"("status");

-- CreateIndex
CREATE INDEX "facade_sides_inspection_id_idx" ON "facade_sides"("inspection_id");

-- CreateIndex
CREATE INDEX "pathology_categories_project_id_idx" ON "pathology_categories"("project_id");

-- CreateIndex
CREATE INDEX "pathology_markers_facade_side_id_idx" ON "pathology_markers"("facade_side_id");

-- CreateIndex
CREATE INDEX "pathology_markers_category_id_idx" ON "pathology_markers"("category_id");

-- CreateIndex
CREATE INDEX "pathology_markers_z_index_idx" ON "pathology_markers"("z_index");

-- CreateIndex
CREATE INDEX "inspection_reports_facade_inspection_id_idx" ON "inspection_reports"("facade_inspection_id");

-- CreateIndex
CREATE INDEX "inspection_reports_version_idx" ON "inspection_reports"("version");
...
-- AddForeignKey
ALTER TABLE "anchor_points" ADD CONSTRAINT "anchor_points_archived_by_id_fkey" FOREIGN KEY ("archived_by_id") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "anchor_points" ADD CONSTRAINT "anchor_points_floor_plan_id_fkey" FOREIGN KEY ("floor_plan_id") REFERENCES "floor_plans"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "anchor_tests" ADD CONSTRAINT "anchor_tests_supervisor_id_fkey" FOREIGN KEY ("supervisor_id") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "floor_plans" ADD CONSTRAINT "floor_plans_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "facade_inspections" ADD CONSTRAINT "facade_inspections_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "facade_inspections" ADD CONSTRAINT "facade_inspections_engineer_id_fkey" FOREIGN KEY ("engineer_id") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "facade_inspections" ADD CONSTRAINT "facade_inspections_created_by_user_id_fkey" FOREIGN KEY ("created_by_user_id") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "facade_sides" ADD CONSTRAINT "facade_sides_inspection_id_fkey" FOREIGN KEY ("inspection_id") REFERENCES "facade_inspections"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pathology_categories" ADD CONSTRAINT "pathology_categories_project_id_fkey" FOREIGN KEY ("project_id") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pathology_markers" ADD CONSTRAINT "pathology_markers_facade_side_id_fkey" FOREIGN KEY ("facade_side_id") REFERENCES "facade_sides"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pathology_markers" ADD CONSTRAINT "pathology_markers_category_id_fkey" FOREIGN KEY ("category_id") REFERENCES "pathology_categories"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "pathology_markers" ADD CONSTRAINT "pathology_markers_created_by_id_fkey" FOREIGN KEY ("created_by_id") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "inspection_reports" ADD CONSTRAINT "inspection_reports_facade_inspection_id_fkey" FOREIGN KEY ("facade_inspection_id") REFERENCES "facade_inspections"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "inspection_reports" ADD CONSTRAINT "inspection_reports_engineer_id_fkey" FOREIGN KEY ("engineer_id") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "inspection_reports" ADD CONSTRAINT "inspection_reports_approver_id_fkey" FOREIGN KEY ("approver_id") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
